import { operateBanner, operateBannerMobile } from '@/assets'
...
import { ODOO_OPERATE_SERVICES } from '@/document'
import { Main } from '@/templates'

const OdooOperateServicePage = () => {
  return (
          ...
          <div className="absolute top-0 right-0 left-0 bottom-0 grid grid-cols-1 md:grid-cols-2">
            ...
            <div className="w-[70%] flex flex-col justify-center px-12">
              <p className="text-2xl md:text-3xl mb-12 font-bold">
                Dịch vụ vận hành <span className="text-primary-gradient">Odoo</span>
              </p>

              <p className="text-sm md:text-base mb-12">
                Triển khai các phiên bản Odoo dành cho Cộng đồng hoặc Doanh nghiệp của bạn trên các
                máy chủ một cách an toàn.
              </p>
            </div>
          </div>
        </div>
...
export default OdooOperateServicePage
