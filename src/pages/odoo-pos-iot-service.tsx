import { posIotBanner, posIotBannerMobile } from '@/assets'
...
import { ODOO_POS_IOT_SERVICES } from '@/document'
import { Main } from '@/templates'

const OdooPosIoTServicePage = () => {
  return (
      ...
      <div className="">
          ...
          <div className="absolute top-0 right-0 left-0 bottom-0 grid grid-cols-1 md:grid-cols-2">
            ...
            <div className="w-[70%] flex flex-col justify-center px-12">
              <p className="text-2xl md:text-3xl mb-12 font-bold">
                Odoo phát triển <span className="text-primary-gradient">POS </span>
                và <span className="text-primary-gradient">IoT</span>
              </p>

              <p className="text-sm md:text-base mb-12">
                Hoàn toàn tùy chỉnh hệ thống Odoo POS theo nhu cầu kinh doanh của bạn.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-secondary">
          <div className="container p-16">
            ...
            <p className="text-center text-xl font-bold mb-12">Những gì chúng tôi cung cấp</p>

            <p className="text-center text-base text-gray mb-32">
              Tùy chỉnh hệ thống POS của bạn với các dịch vụ phát triển của chúng tôi.
            </p>
...
export default OdooPosIoTServicePage
