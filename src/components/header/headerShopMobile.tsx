...
import { CartAndAccountDrawer } from './cartAndAccountDrawer'

interface HeaderShopMobileProps {
  className?: string
}

export const HeaderShopMobile = ({ className }: HeaderShopMobileProps) => {
      ...
      <div className={`w-full flex items-center`}>
        <div className="px-12 flex items-center justify-between w-full">
          ...
          <div className='flex gap-8 items-center'>
            <CartAndAccountDrawer />

            <div onClick={() => toggle()} className="cursor-pointer rounded-full bg-white h-fit">
